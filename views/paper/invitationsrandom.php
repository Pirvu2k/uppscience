...
if(count($existing_members["Finalized"]) > 0 ||
   count($existing_members["Accepted"]) > 0 ||
...
<ul>
    ...
    { 
?>
    <li><?php echo $item->evaluator->given_name . " " . $item->evaluator->family_name; ?></li>
<?php    
    }
?>
</ul>
...
<?php
if(count($existing_members["Accepted"]) > 0)
{
?>
<h4>Experts who accepted evaluating this project</h4>
<ul>
    <?php 
    foreach($existing_members["Accepted"] as $item)
    {
?>
    <li><?php echo $item->evaluator->given_name . " " . $item->evaluator->family_name; ?></li>
<?php    
